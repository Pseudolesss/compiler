...
std::string FillPrototype::visit(Field *field)
{
    ...
    else
    {
        ...
        ::errors.add(field->getLocation(),
                     "redefinition of field " + field->getID() + " already defined at: " + locToStr(l));
    }
    return "done";
}
...
std::string FillPrototype::visit(Method *method)
{
    ...
    else
    {
        ...
        ::errors.add(method->getLocation(),
                     "redefinition of method " + method->getID() + " already defined at: " + locToStr(l));
    }
    return "done";
}
...
std::string FillPrototype::visit(Classe *classe)
{
    if (::prototype.find(classe->getTypeID()) == ::prototype.end())
    {
        ...
        ::prototype[classe->getTypeID()].location = classe->getLocation();
    }
    else
    {
        ...
        errors.add(classe->getLocation(),
                   "redefinition of classe " + classe->getTypeID() + " already define at " + locToStr(l));
    }
...
std::string FillPrototype::visit(ASTnode *asTnode)
{
    std::cerr << "fillprototype in astnode";
    return "should never happend";
}

std::string FillPrototype::visit(Expr *expr)
{
    std::cerr << "fillprototype in expr";
    return "should never happend";
}

std::string FillPrototype::visit(Type *type)
{
    std::cerr << "fillprototype in type";
    return "should never happend";
}

std::string FillPrototype::visit(Exprx *exprx)
{
    std::cerr << "fillprototype in exprx";
    return "should never happend";
}

std::string FillPrototype::visit(Exprxx *exprxx)
{
    std::cerr << "fillprototype in exprxx";
    return "should never happend";
}

std::string FillPrototype::visit(Block *block)
{
    std::cerr << "fillprototype in block";
    return "should never happend";
}

std::string FillPrototype::visit(Dual *dual)
{
    std::cerr << "fillprototype in dual";
    return "should never happend";
}

std::string FillPrototype::visit(Unary *unary)
{
    std::cerr << "fillprototype in iunary";
    return "should never happend";
}

std::string FillPrototype::visit(If *anIf)
{
    std::cerr << "fillprototype in if";
    return "should never happend";
}

std::string FillPrototype::visit(While *aWhile)
{
    std::cerr << "fillprototype in while";
    return "should never happend";
}

std::string FillPrototype::visit(Let *let)
{
    std::cerr << "fillprototype in let";
    return "should never happend";
}

std::string FillPrototype::visit(Assign *assign)
{
    std::cerr << "fillprototype in assign";
    return "should never happend";
}

std::string FillPrototype::visit(Not *aNot)
{
    std::cerr << "fillprototype in not";
    return "should never happend";
}

std::string FillPrototype::visit(And *anAnd)
{
    std::cerr << "fillprototype in and";
    return "should never happend";
}

std::string FillPrototype::visit(Equal *equal)
{
    std::cerr << "fillprototype in equal";
    return "should never happend";
}

std::string FillPrototype::visit(Lower *lower)
{
    std::cerr << "fillprototype in lower";
    return "should never happend";
}

std::string FillPrototype::visit(LowerEqual *lowerEqual)
{
    std::cerr << "fillprototype in lower equal";
    return "should never happend";
}

std::string FillPrototype::visit(Plus *plus)
{
    std::cerr << "fillprototype in plus";
    return "should never happend";
}

std::string FillPrototype::visit(Minus *minus)
{
    std::cerr << "fillprototype in minus";
    return "should never happend";
}

std::string FillPrototype::visit(Times *times)
{
    std::cerr << "fillprototype in time";
    return "should never happend";
}

std::string FillPrototype::visit(Div *div)
{
    std::cerr << "fillprototype in div";
    return "should never happend";
}

std::string FillPrototype::visit(Pow *pow)
{
    std::cerr << "fillprototype in pow";
    return "should never happend";
}

std::string FillPrototype::visit(Minus1 *minus1)
{
    std::cerr << "fillprototype in minus1";
    return "should never happend";
}

std::string FillPrototype::visit(IsNull *isNull)
{
    std::cerr << "fillprototype in is null";
    return "should never happend";
}

std::string FillPrototype::visit(Args *args)
{
    std::cerr << "fillprototype in args";
    return "should never happend";
}

std::string FillPrototype::visit(Function *function)
{
    std::cerr << "fillprototype in function";
    return "should never happend";
}

std::string FillPrototype::visit(Dot *dot)
{
    std::cerr << "fillprototype in dot";
    return "should never happend";
}

std::string FillPrototype::visit(New *aNew)
{
    std::cerr << " fillprototype in new";
    return "should never happend";
}

std::string FillPrototype::visit(ObjID *objID)
{
    std::cerr << " fillprototype in objid";
    return "should never happend";
}

std::string FillPrototype::visit(Literal *literal)
{
    std::cerr << " fillprototype in literal";
    return "should never happend";
}

std::string FillPrototype::visit(IntLit *intLit)
{
    std::cerr << " fillprototype in int literal";
    return "should never happend";
}

std::string FillPrototype::visit(StrLit *strLit)
{
    std::cerr << " fillprototype in str literal";
    return "should never happend";
}

std::string FillPrototype::visit(BoolLit *boolLit)
{
    std::cerr << " fillprototype in bool literal";
    return "should never happend";
}

std::string FillPrototype::visit(Lpar *lpar)
{
    std::cerr << " fillprototype in (";
    return "should never happend";
}

std::string FillPrototype::visit(Rpar *rpar)
{
    std::cerr << " fillprototype in )";
    return "should never happend";
}

std::string FillPrototype::visit(Parenthese *parenthese)
{
    std::cerr << " fillprototype in ()";
    return "should never happend";
}
