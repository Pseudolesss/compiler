...
define %class.IO* @IO.IOprintBool(%class.IO* %self, i1) {
...
define i1 @IO.IOinputBool(%class.IO* %self) {
  %1 = call i8* @IO.IOinputLine(%class.IO* %self)
  %2 = load i8, i8* %1
...
define i32 @IO.IOinputInt32(%class.IO* %self) {
  %1 = alloca i32
