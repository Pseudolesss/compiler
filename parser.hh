...
#line 126 "parser.hh" // lalr1.cc:377
  ...
  parser::symbol_type
  parser::make_INT32 (const location_type& l)
  {
    return symbol_type (token::TOK_INT32, l);
  }

  parser::symbol_type
  parser::make_ISNULL (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_TYPE_IDENTIFIER (const location_type& l)
  {
    return symbol_type (token::TOK_TYPE_IDENTIFIER, l);
  }

  parser::symbol_type
  parser::make_OBJECT_IDENTIFIER (const location_type& l)
  {
    return symbol_type (token::TOK_OBJECT_IDENTIFIER, l);
  }

  parser::symbol_type
  parser::make_INTEGER_LITERAL (const location_type& l)
  {
    return symbol_type (token::TOK_INTEGER_LITERAL, l);
  }

  parser::symbol_type
  parser::make_STRING_LITERAL (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_POW (const location_type& l)
  {
...
#line 1286 "parser.hh" // lalr1.cc:377
