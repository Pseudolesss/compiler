...
#ifndef YY_YY_COMP_TAB_HH_INCLUDED
# define YY_YY_COMP_TAB_HH_INCLUDED
// //                    "%code requires" blocks.
#line 10 "comp.yy" // lalr1.cc:401

  # include <string>
  class driver;

#line 53 "comp.tab.hh" // lalr1.cc:401
...
namespace yy {
#line 169 "comp.tab.hh" // lalr1.cc:401
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == 0 || tok == token::TOK_LBRACE || tok == token::TOK_RBRACE || tok == token::TOK_LPAR || tok == token::TOK_RPAR || tok == token::TOK_COLON || tok == token::TOK_SEMICOLON || tok == token::TOK_COMMA || tok == token::TOK_ASSIGN || tok == token::TOK_BOOL || tok == token::TOK_CLASS || tok == token::TOK_EXTENDS || tok == token::TOK_FALSE || tok == token::TOK_IF || tok == token::TOK_INT32 || tok == token::TOK_ISNULL || tok == token::TOK_LET || tok == token::TOK_NEW || tok == token::TOK_STRING || tok == token::TOK_TRUE || tok == token::TOK_UNIT || tok == token::TOK_WHILE || tok == token::TOK_TYPE_IDENTIFIER || tok == token::TOK_OBJECT_IDENTIFIER || tok == token::TOK_INTEGER_LITERAL || tok == token::TOK_STRING_LITERAL || tok == token::TOK_IN || tok == token::TOK_THEN || tok == token::TOK_DO || tok == token::TOK_ELSE || tok == token::TOK_AND || tok == token::TOK_NOT || tok == token::TOK_EQUAL || tok == 290 || tok == token::TOK_LOWER || tok == token::TOK_PLUS || tok == token::TOK_MINUS || tok == token::TOK_TIMES || tok == token::TOK_DIV || tok == token::TOK_POW || tok == token::TOK_DOT);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::TOK_TYPE_IDENTIFIER, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_TYPE_IDENTIFIER, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OBJECT_IDENTIFIER (location_type l)
      {
        return symbol_type (token::TOK_OBJECT_IDENTIFIER, std::move (l));
      }
#else
      static
      symbol_type
      make_OBJECT_IDENTIFIER (const location_type& l)
      {
        return symbol_type (token::TOK_OBJECT_IDENTIFIER, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_INTEGER_LITERAL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_INTEGER_LITERAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1736 "comp.tab.hh" // lalr1.cc:401




#endif // !YY_YY_COMP_TAB_HH_INCLUDED
